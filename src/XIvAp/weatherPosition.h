...
public:
	...
	// Devuelve lista de estaciones cercanas a la posición del avión (>= WHEATER_GLOB_THRESHOLD = 60 Nm)
	// ordenada por distancia de menor a mayor
	std::vector<WxStation> estacionesCercanas(double lat, double lon, float elapsed);
	...
	// AHS: Añadido para pasar el tipo de nube de la red de AHS a la FSD "moderna"
	FSD::CloudType numTipoNube (string sTipoNube);
