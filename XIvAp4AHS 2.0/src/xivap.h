...
public:
	...
	string realname, callsign, baseairport;
	...
	bool fmcar; //FollowMe car
	string com1name, com2name; //Name coms
...
//	int debugLvl; // Añadido para implementar niveles de debug en comando DEBUG
	...
	void test(string linea); // Añadido para el comando "TEST"
	
	//Añadido para el comando "DEBUG"
	union Debuglevels {
