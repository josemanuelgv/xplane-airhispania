...
const string FSD_HEADS[] = {
	...
	"&C",		// 36
	"&V",		// 37
	"$AX",		// 38 (Añadido para compatibilizar petición de METAR en la red de AHS)
	"$AR"		// 39 (añadido para compatibilizar recepción de METAR en la red de AHS)
};

//#define NUM_FSD_HEADS 38
#define NUM_FSD_HEADS 40
...
// Añadido para compatibilizar petición y recepción de METARs en la red de AHS
#define _FSD_WEADATA_RQ_AHS_     38 //		"$AX"
#define _FSD_WEADATA_RC_AHS_     39 //		"$AR"
#define _FSD_WEADATA_METAR_AHS_  "METAR"
